...
.lyrics-sync-control{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:8px 9px 8px 13px;background:#171a27;border:1px solid #ffffff12;border-radius:8px;color:#c7cada;font-size:13px}
.lyrics-sync-control>div{display:grid;grid-template-columns:repeat(2,64px);gap:7px}.lyrics-sync-control button{min-height:36px}
